          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="mx-auto flex flex-col items-center mb-4">
              <div className="mx-auto gap-2 lg:grid lg:grid-cols-2 lg:gap-4 max-w-xl mb-4">
                ...
                <>
                <p className="font-mono">User have been allocated Room No.: {' '} {form.watch('user')?.roomNo}</p>
                </>
                )}       
                ...
                <>
                    <FormField
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                            <Input placeholder="Enter Room No. to be Allocated" {...field} />
                            </FormControl>
                            <FormDescription />
                            <FormMessage />
                        </FormItem>
                    ...
                    <FormField
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                            <Input placeholder="Enter Total Amount Collected" {...field} />
                            </FormControl>
                            <FormDescription />
                            <FormMessage />
                        </FormItem>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="mx-auto flex flex-col items-center mb-4">
              <div className="mx-auto gap-2 lg:grid lg:grid-cols-2 lg:gap-4 max-w-xl mb-4">
                ...
                <>
                <p className="font-mono">T-Shirt have already been alloted to the User.</p>
                </>
                )}       
                {form.watch('user')?.tShirtAllocation === false && (
                <>
                <p className="font-mono">User have selected{' '}<b>{form.watch('user')?.tShirtSize}</b>{' '}size.</p>
                </>
                )}
              </div>
              ...
              {form.watch('user')?.tShirtAllocation === false && (
                <>   
                    <Button type="submit" disabled={loading} className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-102 duration-300 relative rounded-2xl border border-transparent bg-gray-900 text-white px-5 py-2 hover:bg-purple-500 flex items-center border-white hover:border-none" >Allot T-Shirt</Button>
                </>
                )}
            </form>
          </Form>
