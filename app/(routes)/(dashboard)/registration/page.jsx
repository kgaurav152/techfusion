        ...
        <Card className="mx-auto w-4/5 max-w-xl mb-8 text-left">
          <CardContent>
              <div className="flex items-center justify-center text-center pt-4 mb-8 mt-8">
                <p className="font-bold text-xl font-mono text-red-600">Oops! Registration is closed now!</p>
              </div>
              <div className="flex flex-col items-center pt-4">
                <p className="font-semibold font-mono mb-10">Having Issue with registration contact you Campus Ambassador below:</p>
